...
impl State {
    fn calc_result(&self, result_map: &mut HashMap<State, i32>, graph: &Vec<Vec<i32>>, visited: &mut HashSet<State>, depth: usize, debug: bool) -> i32 {
        ...
        match visited.get(self) {
            ...
            None => { visited.insert(self.clone()); }
        }
                            ...
                            for cat_next in cat_nexts {
                                ...
                                if cat_next != 0 {
                                    ...
                                    match n {
                                        ...
                                        1 if mouse_result_next == -1 => { mouse_result_next = 1; }
                                        _ => {}
                                    }
...
impl Solution {
    pub fn cat_mouse_game(graph: Vec<Vec<i32>>) -> i32 {
        ...
        initial_stat.calc_result(&mut result_map, &graph, &mut visited, 0, false)
    }
}